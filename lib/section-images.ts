...
export const headingImages = {
  header: {
    src: mediaUrl('/images/dr-duffy/source-dr-jan-duffy.jpg'),
    alt: 'Dr. Jan Duffy of Summerlin Real Estate in Las Vegas',
  },
  h1: {
    home: {
    ...
    office: section(
      'h1-about.jpg',
      'Covered courtyard at the Summerlin Real Estate office address in Las Vegas',
    ),
    services: section(
      'h2-guide.jpg',
      'Buyer and seller guide materials overlooking a luxury Las Vegas backyard',
    ),
    sunCity: section(
      'h1-villages.jpg',
      'Gated village street used for Sun City and Del Webb 55+ inventory in Summerlin',
    ),
  },
  h2: {
    homeValue: section(

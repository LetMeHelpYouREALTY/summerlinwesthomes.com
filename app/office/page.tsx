...
const path = '/office';
const title = 'Summerlin Real Estate Office | Homes by Dr. Jan Duffy';
    ...
    '@graph': [
      {
        ...
        itemListElement: [
          ...
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: 'Summerlin Real Estate office',
            item: `${siteUrl}${path}`,
          },
        ],
      },
    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="container mx-auto max-w-4xl px-4 py-12">
        ...
        <p className="mt-4 text-gray-700">
          Open since September 20, 2008. Nevada license {BUSINESS.license}.
      ...
      <section className="bg-white py-12">
        <div className="container mx-auto max-w-4xl px-4">
          <SectionHeading
            ...
            subtitle={`Pin at ${BUSINESS.streetAddress}, ${BUSINESS.addressLocality}.`}
          />
      ...
      <section className="container mx-auto max-w-4xl px-4 py-12">
        ...
        <ul className="list-disc space-y-2 pl-5 text-gray-700">
          <li>Wheelchair-accessible entrance, parking lot, seating, and restroom</li>
          <li>Free parking lot and free parking garage</li>
          <li>Gender-neutral restroom</li>
          <li>Onsite services and online appointments</li>
          <li>Appointment not required</li>
        </ul>
      </section>
      ...
      <section className="bg-white py-12">
        <div className="container mx-auto max-w-6xl px-4">
          <SectionHeading
            ...
            subtitle="Luxury residential sales, buyer representation, new construction, 55+ active-adult community sales, investment consulting, divorce and probate, and relocation."
          />
